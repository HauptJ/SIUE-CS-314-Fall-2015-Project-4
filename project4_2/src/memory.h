...
// L2_BITS=12.
#define	MEMORY_L1_PAGE_SIZE_BITS 19	// each entry in L1 is 64 KB -- DO I NEED TO ADD 3 BITS FOR THE REFERENCE BITS???????? 
...
#define L1_MAX_ENTRIES 0x20 //this should be 32 entries
#define L2_MAX_ENTRIES 0x40 //this should be 64 entries
